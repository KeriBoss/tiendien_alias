...
import 'thong_ke_rut_controller.dart';

class ThongKeRutPage extends StatelessWidget {
  var controller = Get.put(ThongKeRutController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: [
            AppBarWidget(hintText: 'Thống kê rút tiền'),
            Padding(
              padding: const EdgeInsets.symmetric(vertical: 16, horizontal: 24),
              child: Obx(() {
                return item(
                    'Tổng tiền rút', oCcy.format(controller.totalPrice.value));
              }),
            ),
            Padding(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Số tiền rút: ${oCcy.format(int.parse(giaoDich.soTien))} VNĐ",
                      style: TextStyles.defaultStyle,
                    ),
                  ],
                ),
