import 'package:tiendien_alias/pages/admin/nhanVien/ThemNhanVien/themNhanViencontroller.dart';
...
class ThemNhanVienScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Tạo nhân viên')),
                ...
                child: Column(
                  children: [
                    TextFormField(
                        ...
                        decoration:
                            const InputDecoration(label: Text('Tên nhân viên')),
