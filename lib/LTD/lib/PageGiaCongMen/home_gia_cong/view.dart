...
class HomeGiaCongMenPage extends StatefulWidget {
  const HomeGiaCongMenPage({Key? key}) : super(key: key);

  @override
  State<HomeGiaCongMenPage> createState() => _HomeGiaCongMenPageState();
}

class _HomeGiaCongMenPageState extends State<HomeGiaCongMenPage> {
  SampleItem? selectedMenu;
  final logic = Get.put(HomeGiaCongMenLogic());
          ...
          children: [
            ...
            Padding(
              ...
              child: ElevatedButton(
                  onPressed: (){
                    Get.toNamed("/dachsachdonhanggiacongmen");
                  },
                  ...
                  child: ListView(
                    ...
                    children: snapshot.data!.docs.map((DocumentSnapshot document) {
                      ...
                      return SizedBox(
                        ...
                        child: InkWell(
                          onTap: () =>
                              Get.toNamed("/chitietdonhanggiacongmen", arguments: [donHang]),
                          child: Card(
                            child: Column(
