...
class DetailNotificationVndPage extends StatelessWidget {
  NotificationModel notification = Get.arguments[0];
      ...
      child: Column(
        ...
        children: [
          ...
          ListView.builder(
            ...
            itemCount: bill.listBill.length,
            itemBuilder: (context, index) {
              ElectricityBillModel electricityBill = bill.listBill[index];
              return Container(
