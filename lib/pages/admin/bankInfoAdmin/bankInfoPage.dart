...
class BankInfoAdminNVPage extends StatefulWidget {
  BankInfoAdminNVPage({Key? key}) : super(key: key);

  @override
  _WalletPageState createState() => _WalletPageState();
}

class _WalletPageState extends State<BankInfoAdminNVPage> {
  bool _status = true;
  BankInfoAdminController controller = Get.put(BankInfoAdminController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          AppBarWidget(hintText: 'Thông tin ngân hàng'),
          Padding(
